...
def get_class(model_path, labels_path, image_path):
    ...
    if class_name[2:].startswith("Palomas"):
      ...
      return f"Tu imagen es un gorrión y tiene una precisión del {confidence_score:.2f}% \nLos gorriones se alimentan principalmente de semillas, granos, frutas, insectos y pequeños invertebrados. "
